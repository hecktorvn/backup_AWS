    ...
    public static function format($value, $format){
        switch($format){
            ...
            case 'integer':
                ...
                break;
            case 'timestamp':
                if(strrpos($value, ':') > -1) $value = Carbon::createFromFormat('d/m/Y h:i:s', $value)->format('Y-m-d h:i:s');
                else $value = Carbon::createFromFormat('d/m/Y', $value)->format('Y-m-d h:i:s');
                break;
            case 'time':
