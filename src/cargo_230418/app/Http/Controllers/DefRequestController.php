...
class DefRequestController extends Controller
{
    ...
    public static function list($table, &$ret='', $offset=0, $limit=1000, $where=null, &$total=false, $order=null, $joins=null) {
        try {
            $wheres = [];
            ...
            //VERIFICANDO DE INFORMOU LIMITE
            //CASO NÃO SETA 1000 COMO DEFAULT
            if (!is_numeric($limit)) {
                $limit = 5;//1000;
            }

            //VERIFICANDO DE INFORMOU OFFSET
    ...
    public static function listReturn($table, $offset=0, $limit=1000, $where, $total=false, $order=null, $joins=null){
        $return = [];
        self::list($table, $return, $offset, $limit, $where, $total, $order, $joins);
