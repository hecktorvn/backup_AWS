        ...
        start(blood) {
            ...
            data[0] = {
                ...
                classNames: {
                    ...
                    suggestion: 'p-1 pl-2 pr-2 m-0 suggestion',
                    selectable: 'actived',
                    hint: 'style-hint'
                }
            };
            ...
            if(this.isNull(opt.empty) || typeof opt.empty !== 'object'){
                empty = [
                  '<div class="empty-message p-1 pl-2 pr-2 m-0">',
                  'Nenhum resultado para está pesquisa',
                  '</div>'
                ];
            };
            ...
            $(ipt).parents('.twitter-typeahead').addClass('col p-0');
        }
