...
class PaginasController extends Controller
{
    ...
    public function lista_post(Request $req, $name){
        ...
        if (!is_null($data) && isset($data['table'])) {
            ...
            $join = $optPesquisa['join'] ?? null;
            $str_select = $optPesquisa['select'] ?? null;
            $qry = DefRequestController::listReturn($data['table'], $req->start, $req->length, $where, true, $order, $join, $str_select);
            $rr1 = array();
    ...
    public function extrato_carga(Request $req){
        return View('extrato_carga');
    }
    ...
    private static function getDataPage($page) {
        ...
        switch ($page) {
            ...
            case 'ctrc':
                ...
                break;
            case 'manifesto':
                $rt = ['table'=>'manifesto as M', 'primary_key'=>'M.CODIGO'];
                break;
        }
        return $rt;
    }
