<form id="dados_cte">
    <div class="row mb-3">
        ...
        <div class="col-1">
            ...
            <input type="text" required data-mask="onlyNumber" maxlength="3" id="static_serie" name="SERIE" class="form-control form-control-sm">
        </div>
        ...
        <div class="col-2">
            ...
            <input type="text" data-type="date" required id="static_previsao" class="form-control form-control-sm">
        </div>
    ...
    <div class="row mb-3">
        <div class="col-2">
            ...
            <input type="text" id="static_veiculo" name="VEICULO" class="form-control-sm form-control">
        </div>

        <div class="col-4">
            <label for="static_motorista" class="mb-0">Motorista</label>
            <input type="text" id="static_motorista" data-default="00000000000" name="MOTORISTA" class="form-control-sm form-control">
        </div>

        <div class="col-3">
            <label for="static_vendedor" class="mb-0">Vendedor</label>
            <input type="text" id="static_vendedor" name="VENDEDOR" class="form-control-sm form-control">
        </div>

        <div class="col-3">
            <label for="static_situacao_tributaria" class="mb-0">CST</label>
            <input type="text" id="static_situacao_tributaria" data-default="0" name="SITUACAO_TRIBUTARIA" class="form-control-sm form-control">
        </div>
        <!-- FIM DO ROW !-->
    </div>
