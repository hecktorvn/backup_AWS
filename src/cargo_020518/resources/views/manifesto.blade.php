            ...
            <div class="main-content container-fluid be-loading p-0">
                ...
                <div class="tab-container border-bottom">
                    <ul role="tablist" class="nav nav-tabs nav-tabs-warning">
                        ...
                        <li class="nav-item"><a id="dados_a" href="#dados" data-toggle="tab" role="tab" class="nav-link" aria-selected="false">Resumo</a></li>
                    </ul>
...
@if(!empty($mdfe))
    <script>
        $(function(){
            $.manifesto.prepare({'filial': '{{ $filial }}', 'mdfe': '{{ $mdfe }}'});
        });
    </script>
@endif
