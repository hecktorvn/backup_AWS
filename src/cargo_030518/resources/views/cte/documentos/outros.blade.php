<form id="outros_documentos">
    <div class="row mb-3">
        ...
        <div class="col-2">
            ...
            <input type="text" required data-type="onlyNumber" id="static_numero" name="NUMERO" class="form-control form-control-sm">
        </div>
    ...
    <div class="row border-top" style="margin-left: -20px; margin-right: -20px; margin-bottom: -20px;">
        <table id="itens_doc" click class="table table-striped table-hover table-condensed" scrolly="150">
            <thead>
                <tr class="bg-warning">
