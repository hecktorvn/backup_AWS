                                ...
                                <div role="menu" id="imprimir_menu" class="dropdown-menu">
                                    <div class="dropdown-item">
                                        <label class="be-checkbox custom-control custom-checkbox m-0">
                                            <input type="checkbox" name="quebra_emissao" class="custom-control-input">
                                    ...
                                    <div class="dropdown-item">
                                        <label class="be-checkbox custom-control custom-checkbox m-0">
                                            <input type="checkbox" name="quebra_remetente" class="custom-control-input">
                                    ...
                                    <div class="dropdown-item">
                                        <label class="be-checkbox custom-control custom-checkbox m-0">
                                            <input type="checkbox" name="quebra_destinatario" class="custom-control-input">
                                    ...
                                    <div class="dropdown-item">
                                        <label class="be-checkbox custom-control custom-checkbox m-0">
                                            <input type="checkbox" name="resumo_separado" class="custom-control-input">
                                    ...
                                    <div class="dropdown-item">
                                        <label class="be-checkbox custom-control custom-checkbox m-0">
                                            <input type="checkbox" name="resumo_ultima_pagina" class="custom-control-input">
                                    ...
                                    <div class="dropdown-item">
                                        <label class="be-checkbox custom-control custom-checkbox m-0">
                                            <input type="checkbox" name="subdetalhe" class="custom-control-input">
