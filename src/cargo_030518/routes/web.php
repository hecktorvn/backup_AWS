...
Route::group(['prefix' => '/'], function(){
    ...
    Route::group(['middleware' => 'auth:operador'], function(){
        ...
        //MANIFESTO
        Route::post('/manifesto/get', 'EmissaoController@getManifesto');
        Route::post('/manifesto/send', 'EmissaoController@enviarManifesto');
        Route::post('/manifesto/imprimir', 'EmissaoController@imprimirManifesto');
        ...
        Route::post('/manifesto/cancelar', 'EmissaoController@cancelaManifesto');
        Route::post('/manifesto/encerrar', 'EmissaoController@encerrarManifesto');

        Route::get('/manifesto/cancelar', 'EmissaoController@cancelaManifesto');
        Route::get('/manifesto/encerrar', 'EmissaoController@encerrarManifesto');
        Route::get('/manifesto/imprimir', 'EmissaoController@imprimirManifesto');
        Route::get('/manifesto/enviar', 'EmissaoController@enviarManifesto');
        Route::get('/manifesto/{filial}/{codigo}', 'EmissaoController@getManifesto');
        Route::get('/manifesto', 'EmissaoController@manifestoView');

        //EXTRATO DE CARGAS
        Route::get('/extrato/cargas', 'PaginasController@extrato_carga');
