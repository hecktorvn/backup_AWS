...
<div class="main-content container-fluid pt-0">
    <div class="row" id="cadastro_tabela_preco">
        <div style="width: 85%;">
                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" required noFlush id="static_estado_orig" notbock name="ESTADOORIG" class="form-control form-control-sm">
                                    </div>

                                    <div class="col-6">
                                        <label for="static_cidade_orig" class="mb-0">Cidade</label>
                                        <input type="text" required noFlush id="static_cidade_orig" notbock name="ORIGEM" class="form-control form-control-sm">
                                    </div>
                                    <!-- FIM DO ROW !-->
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" required noFlush id="static_estado_dest" notbock name="ESTADODEST" class="form-control form-control-sm">
                                    </div>

                                    <div class="col-6">
                                        <label for="static_cidade_dest" class="mb-0">Cidade</label>
                                        <input type="text" required noFlush id="static_cidade_dest" notbock name="DESTINO" class="form-control form-control-sm">
                                    </div>
                                    <!-- FIM DO ROW !-->
                                </div>
                            </div>
