            ...
            <div class="card" contentLoading>
                ...
                <div class="tab-container border-bottom">
                    <ul role="tablist" class="nav nav-tabs nav-tabs-warning">
                        ...
                        <li class="nav-item"><a id="seguro_a" href="#seguro" data-toggle="tab" role="tab" class="nav-link" aria-selected="false">Nova Aba</a></li>
                ...
                <div class="row p-4">
                    <div class="col-12">
                        <button id="gravarCTe" class="btn btn-space btn-secondary btn-success">Salvar</button>
                        <button id="enviarCTe" class="btn btn-space btn-secondary">Enviar</button>
                    </div>
                </div>
            </div>
            <!-- FIM CARD !-->
