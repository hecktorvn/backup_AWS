$(function(){
    ...
    btn_incluir.on('click', function(){
        ...
        if(!valid) return false;
            ...
            $.outros_documentos.push(form.serializeArray());
            form.flush();

            let eventInc = jQuery.Event('outros:incluir', {'response': $.outros_documentos});
    ...
    btn_excluir.on('click', function(){
        ...
        alert.on('alert:callback', function(e){
            ...
            let eventExcluir = jQuery.Event('outros:excluir', {'response': $.outros_documentos});
    ...
    function drawTable(){
        ...
        if(Object.keys($.outros_documentos).length > 0){
            ...
            $.each($.toObject($.outros_documentos), function(iO, vO){
                let data = [];
