...
<div class="row p-5 pb-0" style="padding-bottom:0 !important;">
    <div class="col-6" id="pesquisa_destinatario">
        <label for="static-consulta_destinatario" class="mb-0">Digite o <b>Nome</b> ou o <b>CNPJ/CPF</b> para a consulta.</label>
        <input type="text" name="consulta_destinatario" class="form-control form-control-sm" id="static-consulta_destinatario">
    </div>
</div>

@include('cadastros.cliente', ['not_extend'=>true, 'not_script'=>true])
<script type='text/javascript' src="{{ asset('js/pages/cte/destinatario.blade.js') }}"></script>
